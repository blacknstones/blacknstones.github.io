      ...
      {showNext ? (
        ...
        <section className='content-container' id='setting'>
          <div className='layout-container story'>
            ...
            <p>
              From life to death, every human being's consciousness is uploaded
              to the cloud for AI to consume.
            </p>
            <p>
              Human can no longer make indenpendent decisions or survive without
              machines.
            </p>
            <p>
            ...
            {opened ? (
              <div className='choices'>
                <div className='prompt'>
                  <p style={{ color: color }}>
                    Zhu has some default settings. Choose yours:{' '}
                  </p>
                </div>
